...
let content = fs.readFileSync('C:/Users/PowerSystem_Desktop/Desktop/Course-management-tool/src/api/requirements.ts', 'utf8');

const newCode = \import { calculateGraduationRequirements } from '../utils/graduationRequirements';
...
content = content.replace(/export const mockRequirementCategoryDetails[\s\S]*/, newCode);
content = content.replace(/const MOCK_DELAY_MS[\s\S]*?\} as const;/g, "");
content = content.replace(/function delay[\s\S]*?\n\}/g, "");
content = content.replace(/function createCourse[\s\S]*?\n\}/g, "");
