...
- **年度別タブ切り替え** で各学年の時間割を個別管理
- 4クォーター(1Q-4Q)別の時間割作成
- 各科目の詳細情報(授業名、教場、担当教員、備考)の登録
- 色分けによる視覚的な管理
- 時間割のコピー機能(クォーター間)
- **科目選択ドロップダウン** - CSVインポート後は登録済み科目から選択可能
...
- **科目一覧からの簡単登録**
  ...
  - **ドロップダウンメニューで科目選択** - 科目情報が自動入力されるので入力ミスを防止
...
4. 授業登録時に「登録済み科目から選択」チェックボックスをONにすると、ドロップダウンメニューから科目を選択可能
