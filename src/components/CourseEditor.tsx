...
export default function CourseEditor({ initial, day, periodId, onSave, onClear, onClose, courses, canDelete, departmentId, quarter, academicYear }: {
  academicYear: number;
